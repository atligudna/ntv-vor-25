...
// modify your program to print a statement about each pizza
  for(String ordpizza in pizzas){
    print("Þú ætlar að fá þér glæsilega $ordpizza");
  }
  print("All $")

// modify your program to print a statement about each pizza
// e.g. "i love eating hawaiian pizza"// Add a line at the
// end of your program statin that "All pizza is great"
